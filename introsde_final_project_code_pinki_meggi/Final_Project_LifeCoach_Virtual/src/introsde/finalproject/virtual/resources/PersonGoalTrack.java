...
public class PersonGoalTrack {
	    ...
	    public PersonGoalTrack(UriInfo uriInfo, Request request,int id) {
	        this.uriInfo = uriInfo;
	        this.request = request;
	        this.id = id;
	    }

	    // REQUEST #1 - GET /persontrack/goals/{personId} - return todays reminders for {personId} 
	    ...
	    public Response getPerson() {
	        ...
	        Response response=service.path("/goals/"+id).request().accept(media).get();
	        return response;
