 ...
 * 
 */
@WebServiceClient(name = "StorageService", targetNamespace = "http://soap.storage.finalproject.introsde/", wsdlLocation = "http://localhost:666/soap/storage?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STORAGESERVICE_QNAME = new QName("http://soap.storage.finalproject.introsde/", "StorageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:666/soap/storage?wsdl");
    ...
    public Storage getStorageImplPort() {
        return super.getPort(new QName("http://soap.storage.finalproject.introsde/", "StorageImplPort"), Storage.class);
    }
    ...
    public Storage getStorageImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.storage.finalproject.introsde/", "StorageImplPort"), Storage.class, features);
    }
