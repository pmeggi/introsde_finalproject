 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.finalproject.introsde/", wsdlLocation = "http://localhost:777/soap/peopledb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://soap.finalproject.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:777/soap/peopledb?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://soap.finalproject.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.finalproject.introsde/", "PeopleImplPort"), People.class, features);
    }
